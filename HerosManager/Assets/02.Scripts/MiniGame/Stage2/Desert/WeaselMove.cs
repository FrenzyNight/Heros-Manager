...
public class WeaselMove : MonoBehaviour
{
    ...
    void SetDirection()
    {
        ...
        x = HM.realWeaselSpeed * Mathf.Cos(direction * Mathf.Deg2Rad);
        y = HM.realWeaselSpeed * Mathf.Sin(direction * Mathf.Deg2Rad);
    ...
    void Death()
    {
        ...
        Debug.Log("Get Meat " + HM.huntWeaselRes.ToString());
        HM.weaselNum -= 1;
        Destroy(gameObject);
    }   
