       ...
       while(true)
        {
            ...
            if(rnd == 0) // 장애물 1개
            {
                ...
                if(rnd == 1) //1번 포인트 소환
                {
                    Instantiate(RockPrefab, SpawnPoint1, Quaternion.identity, GameObject.Find("Water").transform);
                }
                else if(rnd == 2)
                {
                    Instantiate(RockPrefab, SpawnPoint2, Quaternion.identity, GameObject.Find("Water").transform);
                }
                else if(rnd == 3)
                {
                    Instantiate(RockPrefab, SpawnPoint3, Quaternion.identity, GameObject.Find("Water").transform);
                }
            }
            else // 장애물 2개
            {
